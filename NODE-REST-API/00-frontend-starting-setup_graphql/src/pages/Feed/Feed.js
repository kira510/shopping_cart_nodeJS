...
class Feed extends Component {
  ...
  loadPosts = direction => {
    ...
    /**
     * we are using FetchPosts as a dummy name making it meaningful and we
     * are just defining the variables within the query
     * These variables are defined as another query
     */
    const graphqlQuery = {
      query: `
  ...
  finishEditHandler = postData => {
    ...
    fetch('http://localhost:8080/post-image', {
      ...
      .then(fileResData => {
        ...
        // below is an example of query without using variables
        let graphqlQuery = {
          query: `
            mutation {
